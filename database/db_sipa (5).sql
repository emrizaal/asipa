...
--
-- Host: localhost
-- Waktu pembuatan: 06. Juni 2016 jam 06:59
-- Versi Server: 5.5.16
-- Versi PHP: 5.3.8
...
(12, 1, 2, 1, 1, 1, 15, 'PC', '1TB, core i5, RAM 2GB', 'Intel', 'Unit', 3, 3000000, 3, 'Speknya kurang lengkap', NULL, 1, 2, '1', '2016-06-02 14:45:36', 8, '', 0),
...
(6, 2, 5, 'kontrak', 'kategori.sql'),
(7, 1, 5, 'aaaa', 'db_sipa_old.sql'),
(8, 2, 5, 'ddd', '');
...
INSERT INTO `paket` (`ID_PAKET`, `ID_USER`, `ID_TEAM_PENERIMA`, `ID_TEAM_HPS`, `NAMA_PAKET`, `STATUS`, `TANGGAL_DIBUAT`, `TAHUN_ANGGARAN`, `TOTAL_ANGGARAN`, `LAST_UPDATE`, `TENDER_A`, `NAMA_A`, `NPWP_A`, `ALAMAT_A`, `TENDER_B`, `NAMA_B`, `NPWP_B`, `ALAMAT_B`, `TENDER_C`, `NAMA_C`, `NPWP_C`, `ALAMAT_C`, `KETERANGAN_GAGAL_KONTRAK`, `PENYEDIA`, `WAKTU_PENGADAAN`, `ID_KATEGORI`) VALUES
(1, 6, 1, 1, 'Dokumen Paket JTK & AN', 2, '2016-06-10 14:12:12', '2016', 2000000, '2016-06-15 17:00:00', '1', '1', '1', '1', '', '', '', '', '', '', '', '', 'aaa', '1', '20/Hari Kerja', 0),
(2, 5, 1, 1, 'Paketrok Lah', NULL, '2016-06-01 02:11:00', '2016', 200000000, '2016-06-04 17:00:00', '44', '44', '44', '44', '', '', '', '', '', '', '', '', '', '44', '10/Hari Kalender', 0);
...
(2, 12, 1, '2016-06-04 17:00:00', 2, 1, 'aaa', 0),
(3, 12, 1, '2016-06-04 17:00:00', 1, 1, 'AAA', 0),
(4, 11, 1, '2016-06-04 17:00:00', 1, 2, 'eeee', 0),
(5, 13, 1, '2016-06-05 17:00:00', 1, 1, 'rewrwerwer', 0),
(6, 11, 1, '2016-06-05 17:00:00', 1, 2, 'asdasd', 0);
...
(35, 2, 7, 3, NULL, 9, '2016-06-05 06:10:02', 7, 0, 0),
(36, 2, 5, 4, NULL, 10, '2016-06-05 06:11:20', 5, 0, 0),
(37, 1, 5, 4, NULL, 10, '2016-06-05 07:30:58', 5, 0, 0);
