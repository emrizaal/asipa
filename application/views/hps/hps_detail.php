        ...
        <div class="card">
          <div class="card-header">
            <div class="card-title">
              <span class="title">Form HPS (Harga Perkiraan Sendiri)</span>
            </div>
          </div>
          <div class="card-body">
          ...
          <form class="form-horizontal row-fluid form-usulan-noborder">
            <div class="col-md-4">
              <div class="control-group ">
                ...
                <div class="controls">
                  <input readonly type="text" name="NM_PAKET" id="NM_PAKET"  value="<?=$paket['NAMA_PAKET']?>" class="form-control">
                </div>
              </div>
              <div class="control-group ">
            ...
            <center>
              <div class="control-group">
                <div class="controls">
                  ...
                  <a href="<?=base_url()?>Hps" class="btn btn-warning">Cancel</a>
                </div>
