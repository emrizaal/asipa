    ...
    <div class="side-body padding-top"  style="padding-top:85px;">
     <div class="row no-margin-bottom">
      ...
      <div class="row-fluid " style="height:auto;background:#fff">
        <a href="#" class="btn btn-info" style="position: fixed;right: 0px;
        top: 400px;display: block;" 
        data-toggle="tooltip" data-placement="left" data-html="true" title="Tambah Kelompok" 
        id="addKelData"><i class="fa fa-plus"></i></a>
