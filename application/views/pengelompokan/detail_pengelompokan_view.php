<div class="card">
 <div class="card-body"  style="padding: 0px 20px !important;">
  <div class="sub-title">Nama Paket Penglompokan  
  <input type="text" style="width: 30%; margin-left: 1%;" name="nama" class="form-control" placeholder="Masukan Nama Paket Pengelompokan"> </div>
    <div>
    </div>
    <div class="sub-title">Tim HPS 
    <select name="tim" class="form-control" style="width: 20%;margin-left:1%;">
      <?php foreach($tim as $t){?>
      <option value="<?=$t['ID_TEAM_HPS']?>"><?=$t['NAMA_TIM']?></option>
      <?php } ?> 
    </select></div>
    <div>
